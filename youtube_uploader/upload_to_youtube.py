...
if __name__ == '__main__':
    ...
    title = f"{today_str} 주식뉴스 | AI가 분석한 오늘의 증시 핵심 포인트 | OU증권 경제뉴스 패러디. 이 포스팅은 쿠팡파트너스 활동으로 일정보수를 지급받습니다."
    description = f"""AI가 매일 아침 전해드리는 가장 신박한 증시 패러디! 이 shorts는 쿠팡파트너스 활동으로 일정보수를 지급받습니다.
