...
if __name__ == '__main__':
    ...
    title = f"{today} AI가 분석한 오늘의 유머_증권/경제뉴스 패러디 | OU_증권/경제뉴스 패러디. 이 포스팅은 쿠팡파트너스 활동으로 일정보수를 지급받습니다."
    
    description = f"""매일 아침 AI가 전하는 재미있는 증권/경제뉴스 패러디!이 포스팅은 쿠팡파트너스 활동으로 일정보수를 지급받습니다.
